...
class ProjectState(str, Enum):
    ...
    CONFIG_READY = "config_ready"  # Time/Activity/Platform config generated
...
def utc_now_iso() -> str:
    """UTC ISO-8601 timestamp for persisted project artifacts."""
...
class SimulationParameters:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "event_config": asdict(self.event_config) if self.event_config else None,
...
class Project:
    ...
    activation: Optional[EventConfig] = None
    ...
    def transition(self, new_state: ProjectState, message: str = "") -> None:
        ...
        if new_state != ProjectState.FAILED:
